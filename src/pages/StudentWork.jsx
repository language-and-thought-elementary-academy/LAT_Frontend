  ...
  return (
    <section style={{ background: '#fff', padding: 'clamp(56px,7vw,104px) 0' }}>
      <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
        <p style={{ font: "400 16px/1.8 'Noto Sans KR',sans-serif", color: '#667085', margin: '0 0 40px', maxWidth: '700px' }}>학생들이 실제로 작성한 글과<br />첨삭 및 다시쓰기 과정을 소개합니다.</p>
        ...
        <div style={{ background: '#fff', border: '1px solid #D0D5DD', borderRadius: '14px', padding: '32px 30px', marginTop: '36px' }}>
          <h2 style={{ font: "600 18px/1.4 'Noto Sans KR',sans-serif", color: '#1849A9', margin: '0 0 14px' }}>[학생 글쓰기 사례]</h2>
          <p style={{ font: "400 15px/1.8 'Noto Sans KR',sans-serif", color: '#667085', margin: 0 }}>공개 동의가 확인된 학생 원고만 게시합니다.<br />학생 이름과 학교 정보는 비식별 처리 후 등록됩니다.</p>
        </div>
      </div>
    </section>
  )
