  ...
  return (
    <section style={{ background: '#fff', padding: 'clamp(60px,7vw,110px) 0' }}>
      <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
        ...
        {tEmpty && (
          <p style={{ font: "400 16px/1.8 'Noto Sans KR',sans-serif", color: '#667085', background: '#EFF8FF', border: '1px solid #B2DDFF', borderRadius: '12px', padding: '34px 30px', margin: 0 }}>선택한 학년의 강사 배정 정보가 아직 등록되지 않았습니다.<br />강사 약력과 담당 학년이 확정되면 이곳에 표시됩니다.</p>
        )}
