        ...
        <dl style={{ margin: 0, display: 'flex', flexDirection: 'column' }}>
          {locationRows.map(r => (
            <div key={r.k} style={{ display: 'grid', gridTemplateColumns: '110px 1fr', gap: '16px', padding: '22px 0', borderTop: '1px solid #E4EDF7' }}>
              <dt style={{ font: "600 15px/1.6 'Noto Sans KR',sans-serif", color: '#1849A9', margin: 0 }}>{r.k}</dt>
              <dd style={{ font: "400 16px/1.7 'Noto Sans KR',sans-serif", color: '#667085', margin: 0 }}>{r.v}</dd>
            </div>
          ))}
        </dl>
        <div>
