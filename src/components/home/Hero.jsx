...
export default function Hero() {
  return (
    <section className="editorial-hero" aria-labelledby="hero-h" style={{ background: 'linear-gradient(155deg,#081A33 0%,#102A56 58%,#173F86 100%)', position: 'relative', overflow: 'hidden' }}>
      <div className="editorial-hero__graphic" style={{ position: 'absolute', inset: 0 }} aria-hidden="true"></div>
      <div className="editorial-hero__content" style={{ position: 'relative', maxWidth: '1240px', margin: '0 auto', padding: 'clamp(84px,11vw,168px) 24px clamp(72px,9vw,140px)' }}>
        ...
        <p className="hero-annotation" style={{ font: "400 11px/1.6 var(--font-family-primary)", color: 'rgba(255,255,255,.42)', letterSpacing: '.06em', margin: '56px 0 0' }}>[HERO IMAGE 16:9 — 학생 읽기 장면, Deep Navy overlay, 좌측 텍스트용 negative space 확보]</p>
      </div>
    </section>
  )
}
