    ...
    <section className="editorial-section numbered-section section-teachers" aria-labelledby="teach-h" style={{ background: '#EFF8FF', padding: 'clamp(72px,9vw,140px) 0' }}>
      <div className="editorial-container" style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ marginTop: '36px' }}>
          <SiteLink href="#/teachers" className="hover-bg-1849a9-fg-fff" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minHeight: '50px', padding: '0 28px', border: '1px solid #1849A9', borderRadius: '4px', color: '#1849A9', font: "600 15px/1 var(--font-family-primary)", textDecoration: 'none', background: '#fff' }}>강사진 보기</SiteLink>
        </div>
      </div>
    </section>
  )
