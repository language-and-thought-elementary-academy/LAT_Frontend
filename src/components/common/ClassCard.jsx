...
export default function ClassCard({ c, headingLevel = 'h3', showRoom = false }) {
  ...
  return (
    <article style={{ background: '#fff', border: '1px solid #D0D5DD', borderRadius: '14px', padding: '32px 30px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
      <p style={{ font: "600 11px/1 'Noto Sans KR',sans-serif", letterSpacing: '.16em', color: '#1849A9', margin: 0 }}>{c.code}</p>
      <Heading style={{ font: "600 clamp(20px,1.6vw,24px)/1.35 'Noto Sans KR',sans-serif", color: '#1849A9', margin: 0 }}>{c.name}</Heading>
