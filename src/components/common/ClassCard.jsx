...
export default function ClassCard({ c, headingLevel = 'h3', showRoom = false }) {
  ...
  return (
    <article className="editorial-card class-card" style={{ background: '#fff', border: '1px solid #D0D5DD', borderRadius: '14px', padding: '32px 30px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
