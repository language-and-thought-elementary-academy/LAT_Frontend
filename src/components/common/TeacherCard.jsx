...
export default function TeacherCard({ t, headingLevel = 'h3', linkMinHeight = true }) {
  ...
  return (
    <article className="editorial-card teacher-card" style={{ background: '#fff', border: '1px solid #D0D5DD', borderRadius: '14px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div className="teacher-placeholder" role="img" aria-label="강사 사진 준비 중" style={{ aspectRatio: '4/5', background: '#EAF3FC', display: 'grid', placeItems: 'center', color: '#475467', font: '400 11px/1.5 var(--font-family-primary)', letterSpacing: '.06em', textAlign: 'center', padding: '12px' }}>[강사 포트레이트 4:5]</div>
